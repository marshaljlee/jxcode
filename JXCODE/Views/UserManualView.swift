        ...
        case .chat:
            [
                ...
                ManualSection(
                    ...
                    body: "Hover over any assistant message and click the branch icon to fork the conversation from that point. JXCODE opens a new session with the history up to that message, leaves the original untouched, and switches to the new branch. Forked branches also appear in the external claude --resume picker."
                ),
                ManualSection(
        ...
        case .attachments:
            [
                ...
                ManualSection(
                    ...
                    body: "Pasting (⌘V) is smart — JXCODE detects what's in the clipboard and handles it automatically.",
                    items: [
        ...
        case .github:
            [
                ManualSection(
                    ...
                    body: "Click the GitHub Mark button at the top of the sidebar to open the GitHub panel. After connecting your GitHub account, your repositories are listed and can be added to JXCODE with one click."
                ),
                ManualSection(
                    title: "Adding a Repository",
                    body: "Search for a repository by name, then click Add. JXCODE clones it automatically and opens it as a new project.",
                    items: [
                        ...
                        KeyValueItem(key: "checkmark", value: "Already added to JXCODE", symbolName: "checkmark.circle.fill", symbolColor: .green),
                    ]
                ),
            ]
        ...
        case .settings:
            [
                ManualSection(
                    ...
                    body: "Choose JXCODE → Settings from the menu bar or press ⌘, to open the Settings window. Settings are organized into four tabs: General, Message, Slash Commands, and Shortcuts."
                ),
                ManualSection(
                    title: "General Tab",
                    ...
                    items: [
                        ...
                        KeyValueItem(key: "Notifications", value: "Show a system notification when a response completes while JXCODE is in the background"),
                    ],
                ...
                ManualSection(
                    title: "Themes",
                    body: "JXCODE ships with six accent color themes. Preview each one directly from the theme picker — the whole app recolors live as you choose.",
                    items: [
                ...
                ManualSection(
                    ...
                    body: "Open JXCODE → Check for Updates… to run Sparkle's update check manually. Updates are also checked automatically on launch."
                ),
            ]
        }
    }
