...
public actor CLISessionStore {
    ...
    /// Resolve the on-disk projects directory for a JXCODE-known cwd. Prefers
    ...
    /// found. Survives JXCODE-side rewrites (PickerExposer, LegacyMigrator) that
    ...
    /// jsonl itself doesn't carry the JXCODE project UUID.
